				...
				<?php while ( $related_posts->have_posts() ) : $related_posts->the_post(); ?>
					<li class="fusion-carousel-item"<?php echo wp_kses_post( $carousel_item_css ); ?>>
						<div class="fusion-carousel-item-wrapper">
							...
							echo fusion_render_first_featured_image_markup( get_the_ID(), $featured_image_size, get_permalink( get_the_ID() ), true, false, false, 'disable', $display_post_title, 'related' );
							...
							<?php if ( 'title_below_image' == Avada()->settings->get( 'related_posts_layout' ) ) : // Title on rollover layout. ?>
								...
								<div class="fusion-carousel-meta">
									<span class="fusion-date"><?php echo esc_attr( get_the_time( Avada()->settings->get( 'date_format' ), get_the_ID() ) ); ?></span>
